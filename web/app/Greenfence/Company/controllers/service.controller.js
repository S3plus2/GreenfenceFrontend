(function() {
	angular.module('company').controller('ServiceCtrl', ['$rootScope', '$scope', '$routeParams', '$compile', '$location', '$translate', '$timeout', 'OperationService', 'ServiceService', 'ss_alert', 'ui',
