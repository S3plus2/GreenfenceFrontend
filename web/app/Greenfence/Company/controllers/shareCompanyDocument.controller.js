(function() {	
	...
	angular.module('company').controller('ShareCompanyDocumentCtrl', ['$rootScope', '$scope', '$filter', 'UserService', 'CompanyDocumentService', 'CompanyFolderService', 'ShareCompanyDocumentService', 'ss_alert', '$translate', 'ui', '$http', '$timeout',
