(function() {
	...
	angular.module('company').controller('OperationCtrl', ['$rootScope', '$scope','$routeParams', '$compile', '$location', '$translate', 'OperationService', 'ss_alert', 'ui', 'list','$upload',
		function($rootScope,$scope,$routeParams, $compile, $location, $translate, OperationService, ss_alert, ui, list,$upload) {
			...
			var showSelectedBusinesses = function() {
				var list = []		
				temp_business_type  = getSelectedBusinessTypeElement()
				selected_business_sub_types = getSelectedBusinessSubTypeElement()
