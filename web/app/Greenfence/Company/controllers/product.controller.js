(function() {
	...
	angular.module('company').controller('ProductCtrl', ['$rootScope', '$scope', '$compile', '$location', '$translate', '$timeout', 'OperationService', 'ProductService', 'ss_alert', 'ui',
		function($rootScope, $scope, $compile, $location, $translate, $timeout, OperationService, ProductService, ss_alert, ui) {
			...
			var showSelectedProducts = function() {
				var list = []		
				temp_category  = getSelectedProductCategoryElement()
