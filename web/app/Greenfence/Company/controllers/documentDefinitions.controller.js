(function() {
	angular.module('company').controller('DocumentDefinitionsCtrl', ['$rootScope', '$scope', '$routeParams', '$compile', '$location', '$translate', '$timeout', 'DocumentDefinitionsService', 'OperationService','ss_alert', 'ui', function($rootScope, $scope, $routeParams, $compile, $location, $translate, $timeout, DocumentDefinitionsService, OperationService, ss_alert, ui) {
